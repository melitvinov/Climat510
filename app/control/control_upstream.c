...
void write_output_register(uint16_t How, uint8_t fType, uint16_t nAddress,char* nErr, module_fandata_t *fandata)
{
    SetOutIPCReg(How, fType, nAddress, nErr, fandata);
}
