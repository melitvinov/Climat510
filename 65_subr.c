...
/*!
\brief Если первый аргумент меньше второго, то приравниваем его к второму аргументу
@param int16_t *f_in проверяемое значение, int16_t f_gr задаваемое значение
*/ 
