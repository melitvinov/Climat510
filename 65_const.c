...
********************************
------------------------------*/
#define FWVersion		"ver.09/15.1.00.22"
												// 22   Контрольные суммы убраны и восстановление механизмов то же, датчик t2 из расчетв экрана убрал
												// 21_4 Новая контрольная сумма при приеме Ethernet пвкета
												// 21_3 учет датчика температуры в расчете экранов убрал
